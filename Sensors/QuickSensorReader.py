## identical to SensorReader.py but nothing stored in or read from the database, no mail sent, etc.  Just for checking temps.
...
class QuickSensorReader():
	'Class for reading DHT22 sensors'

	def __init__(self, configurations):
		self.logger = logging.getLogger(__name__)
		self.logger.info("QuickSensorReader instantiation started")
		...
		self.logger.info("QuickSensorReader instantiated")
